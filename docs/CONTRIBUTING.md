...
Bugs are tracked as [GitHub issues](https://github.com/ivan-pinatti/pre-commit-checklists/issues);
report one by [opening a new issue](https://github.com/ivan-pinatti/pre-commit-checklists/issues/new).
